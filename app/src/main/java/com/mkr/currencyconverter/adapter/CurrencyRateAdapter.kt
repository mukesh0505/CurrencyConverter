...
class CurrencyRateAdapter: RecyclerView.Adapter<CurrencyRateAdapter.CurrencyViewHolder>() {
    ...
    lateinit var list: ArrayList<CurrencyRate>
    ...
    override fun onBindViewHolder(p0: CurrencyViewHolder, p1: Int) = p0.bind(CurrencyValueViewModel(list[p1].currency, list[p1].rate, source, amount))
